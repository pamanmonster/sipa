...
class Auth extends CI_Controller {
	...
	public function index() {
		...
		} else if (!$this->ion_auth->is_admin()) // remove this elseif if you want to enable this for non-admins
		{
			...
			$this->utilities->loadView('manajemen_user', $this->data);
		}
	}
	...
	public function user_list() {
		...
		//$list = $this->ion_auth->where('field', 'value')->users()->result();
		...
		foreach ($list as $k => $li) {
			...
			$row[] = $li->last_name;
			$row[] = $li->email;
			$row[] = $list[$k]->groups = $this->ion_auth->get_users_groups($user->id)->result();
			$row[] = $li->active;
			$row[] = $li->user_id;
			$data[] = $row;
		}
	...
	public function create_user() {
		...
		if ($this->form_validation->run() === TRUE && $this->ion_auth->register($identity, $password, $email, $additional_data)) {
			...
			$this->utilities->loadView('auth' . DIRECTORY_SEPARATOR . 'create_user', $this->data);
	...
	public function edit_user($id) {
		...
		$this->utilities->loadView('auth' . DIRECTORY_SEPARATOR . 'edit_user', $this->data);
